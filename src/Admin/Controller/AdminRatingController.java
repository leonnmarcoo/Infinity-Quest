...
// === Update delete ==============================================
    @FXML
    private Button ratingDeleteButton;

    @FXML
    private Button ratingUpdateButton;

    @FXML
    void ratingDeleteButtonHandler(ActionEvent event) {

    }

    @FXML
    void ratingUpdateButtonHandler(ActionEvent event) {

    }
    
// =================================================
    @FXML
    private TableView<Rating> ratingDataTable;

    @FXML
    private TableColumn<Rating, Integer> ratingCol;

    @FXML
    private TableColumn<Rating, Integer> ratingContentCOl;

    @FXML
    private TableColumn<Rating, Integer> ratingIDCol;

    @FXML
    private TableColumn<Rating, Integer> ratingUserCol;
